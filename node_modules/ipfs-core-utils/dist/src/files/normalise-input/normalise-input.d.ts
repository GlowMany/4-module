declare function _exports(input: import('ipfs-core-types/src/utils').ImportCandidateStream, normaliseContent: (content: ToContent) => AsyncIterable<Uint8Array>): AsyncGenerator<import("ipfs-unixfs-importer/types/src/types").ImportCandidate, void, undefined>;
export = _exports;
