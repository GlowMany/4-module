...
declare namespace Multibases {
    export { MultibaseCodec, LoadBaseFn, AbortOptions };
}
type MultibaseCodec = import('multiformats/bases/interface').MultibaseCodec<any>;
type LoadBaseFn = import('./types').LoadBaseFn;
