...
declare namespace Multicodecs {
    export { BlockCodec, LoadCodecFn, AbortOptions };
}
type BlockCodec = import('multiformats/codecs/interface').BlockCodec<any, any>;
type LoadCodecFn = import('./types').LoadCodecFn;
